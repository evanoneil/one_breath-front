...
const Header = ({ onHideNav, onShowNav, showNav, siteTitle }) => (
  <div className="bg-white flex w-100 vh-7 pv3 flex justify-between items-center top-0 z-2">
    ...
    <div className="center-m w-100-l w-50-m w-90 mw70 flex justify-between justify-around-l items-center ph4 pa2-ns">
      ...
      <nav className={cn(styles.nav, showNav && styles.showNav)}>
        <ul>
          ...
          <li className="blue">
            <a className="ttu mid-gray f5 no-underline dn dib-l blue" href="https://actionnetwork.org/forms/sign-up-for-updates-163">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
