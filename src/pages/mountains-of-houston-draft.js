          ...
          <div class="vh-100 dt w-100 tc bg-dark-gray white cover"
            ...
            <div class="dtc v-mid ">
              <div class="w-75 center">
                ...
                <h1 class="center f1 f-subheadline-l b fw7 tl  mh-auto ttu animated fadeIn a1 d2 mb0" style={{ color: 'white' }}>The Mountains</h1>
                <h1 class="center f1 f-subheadline-l b fw7 tl  mh-auto ttu animated fadeIn a5 d4 mt0" style={{ color: 'white' }}>of</h1>
                <h1 class="center f1 f-subheadline-l b fw7 tl white mh-auto ttu animated fadeIn a5 d4 mt0">Houston</h1>
              </div>
          ...
          <div class="wrapper">
            ...
            <div class="center w-70 f5 pt5 lh-copy ph2">
              ...
              <blockquote class="ph0 f5 f1-ns w-100 center b--none mb0">
                <p class="fw7 lh-title orange f3 mb0">When you see mountains in Houston, be suspicious.
...
<iframe src="https://felt.com/map/Houston-Landfills-Map-Invisible-Houston-GKyE0QqbQVKzBOM784cuzB" class="w-100 vh50"></iframe>
...
<blockquote class="ph0 f5 f1-ns w-100 center b--none mb0">
                <p class="fw7 lh-title orange f3 mb0">5 out of 5 city-owned landfills (100 percent) and 6 of the 8 city-owned incinerators (75 percent) were sitedinBlack neighborhoods.
                </p></blockquote>
<p>
After my study for the Bean case, my career became linked with the environmental justice movement, and I have since then had the opportunity to work with communities all over the world. 
</p><p>I left Houston in 1987 and returned 24 years later. Like Rip Van Winkle, I can see clearly what has and has not changed. What I found upon my return in 2011 was a situation that is more complex, perhaps, but has the same basic dynamics of inequality. In this article, I give a brief history of waste management practices in Houston, look at ongoing challenges and suggest some first steps towards strategies for the future. Houstonians can learn from other diverse cities about how to work together to fight environmental injustices, but the first step is to understand the scope of the problem.	
</p><h2>“UNOFFICIALLY ZONED FOR GARBAGE”: HISTORICAL CONTEXT</h2>
<p>On May 16, 1967, more than 46 years ago, Black Houstonians picketed the Holmes Road dump in the southeast Sunnyside neighborhood where an 8-year-old Black child had drowned. Not only did residents see the placement of the city dump in their neighborhood as unfair, but that placement had actually resulted in the death of an innocent child. The landfill protesters joined forces with another group protesting racism in Houston schools (charging that Black students were disciplined more harshly than white students) in holding rallies and marches that later fueled the student resistance and police overreaction that led to the 1967 Texas Southern University “riot.” According to the 1968 Report of the National Advisory Commission on Civil Disorders, this was the only major civil disturbance that occurred in Houston during the turbulent 1960s.
</p><p>In 1971, Houston elected its first Black city councilmember, Judson Robinson, Jr. Once he was elected, the first crisis he faced involved a city-owned landfill. Councilmember Robinson had to quell a near-riot at the Kirkpatrick landfill in the mostly Black Trinity Gardens neighborhood. Protesters were demanding that the city-owned landfill be closed. After six months of intense demonstrations, the protestors prevailed.		
...
<blockquote class="ph0 f5 f1-ns w-100 center b--none mb0">
                <p class="fw7 lh-title orange f3 mb0">The original bucolic character of the neighborhood has been forever lost as the sprawling landfill looms near soccer fields, homes and places of worship.
                </p></blockquote>
                <img src="https://houston-arrow.netlify.app/4-images/skyline.JPG" class="w-100 w-90-ns"/>
                <img src="https://houston-arrow.netlify.app/4-images/skyline.JPG" class="w-100 w-90-ns"/>
               ...
               </p><p>After 1978, as the Bean case began making its way through the courts, no other Type I landfills were built in the city. Houston instead began sending some of its household garbage to four landfills located outside of the city. But the discriminatory pattern did not change: 3 of the 4 non-Houston landfills are located in census tracts where the majority of the population are people of color — Waste Management (76.6 percent), Atascocita (86.0 percent) and BFI Blue Ridge (85.7 percent).			
               </p><h2>ILLEGAL DUMPING GROUNDS				</h2><p>
Changing the siting of city-owned and private landfills alone will not fully address Houston’s problems with unequal exposure to waste. I also identified illegal dumping as a major problem in Invisible Houston (1987), and it continues to be a problem today. In June 2012, Mayor Anise Parker appointed the Task Force on Illegal Dumping to bring together the Solid Waste Department, neighborhoods, the police and the Mayor’s Office of Sustainability to coordinate enforcement and education in an effort to cut down on roadside dumping.	
...
<blockquote class="ph0 f5 f1-ns w-100 center b--none mb0">
                <p class="fw7 lh-title orange f3 mb0">It is clear that the same Houston council districts that have hosted solid waste facilities over the years have become prime targets for illegal dumping. This should have been easy to predict: Illegal dumping was already a problem near the Whispering Pines landfill in 1980.
                </p></blockquote>
...
<p>Houston collects approximately 420,000 tons of solid waste and another 71,000 tons of yard waste annually from residents. Most of this waste ends up at landfills. Houston is one of the few major U.S. cities without a garbage fee, despite the fact that having extra funds in the city’s Solid Waste Department could go a long way to addressing critical waste management challenges, from illegal dumping to citywide recycling.	
</p><p>The city picks up garbage at 375,000 homes. Currently, 105,000 homes have single-stream recycling (all recycling materials mixed together) and another 100,000 homes have dual-stream recycling (fiber materials such as paper are separated from materials such as plastic and cans) at the curbside. But even with curbside pickup convenience, Houston has a dismal recycling rate. In 2009, Waste and Recycling News reported that Houston ranked 9th out the 10 largest U.S. cities in the United States in terms of recycling — only 16.7 percent of Houston trash was recycled, compared to 65 percent for Los Angeles, 60 percent for San Jose, 55 percent for New York and 52.4 percent for Chicago. Only San Antonio was worse than Houston, with a 4 percent recycling rate in 2009.				
</p><p>In March 2013, Houston won a $1 million grant from the Bloomberg Philanthropies’ Mayors Challenge to implement a “One Bin for All” project where residents place all their trash and recycling in one bin for collection, to be separated later at a transfer station. City leaders believe newer technologies that allow this all-in-one collection directed to a Material Recovery Facility (MRF), or “dirty MRF” collection, will increase Houston’s recycling rate from the current 14 percent to at least 75 percent. Some critics of the experiment oppose it, however, because they feel more effort and resources should be spent on expanding single-stream recycling to all Houston neighborhoods.
...
<blockquote class="ph0 f5 f1-ns w-100 center b--none mb0">
                <p class="fw7 lh-title orange f3 mb0">Houston has three garbage transfer stations, and all three are located in minority neighborhoods. 
                </p></blockquote>
...
</p><p>Produced by One Breath (onebreathhou.org) and Environmental Defense Fund (edf.org) Designed by Evan O’Neil (evanoneil.studio)
</p><p>All photos except on pages 26 & 27 by Ben Corda (bencorda.com)
</p><p>Photo on pages 26 & 27 provided by Dr. Bullard
</p><p>Illustration of a possible healthier and more livable city for all by Sanbles (sanbles.com)
</p>
